(function () {
	...
	var fails$10 = fails$11; // Detect IE8's incomplete defineProperty implementation
	...
	var NASHORN_BUG = getOwnPropertyDescriptor$8 && !$propertyIsEnumerable$1.call({
	  1: 2
	...
	var getBuiltIn$u = function (namespace, method) {
	  return arguments.length < 2 ? aFunction$T(global$L[namespace]) : global$L[namespace] && global$L[namespace][method];
	};
	...
	var fails$_ = fails$11; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	...
	var setGlobal$3 = function (key, value) {
	  try {
	    ...
	    Object.defineProperty(global$J, key, {
	      value: value,
	      configurable: true,
	      writable: true
	    });
	...
	var requireObjectCoercible$g = requireObjectCoercible$i; // `ToObject` abstract operation
	...
	var wellKnownSymbol$E = function (name) {
	  if (!has$n(WellKnownSymbolsStore$1, name) || !(NATIVE_SYMBOL$1 || typeof WellKnownSymbolsStore$1[name] == 'string')) {
	    if (NATIVE_SYMBOL$1 && has$n(Symbol$1, name)) {
	...
	var floor$a = Math.floor; // `ToInteger` abstract operation
	...
	var min$a = Math.min; // `ToLength` abstract operation
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  for (key in O) !has$j(hiddenKeys$4, key) && has$j(O, key) && result.push(key); // Don't enum bug & hidden keys
	...
	var isForced$5 = function (feature, detection) {
	  ...
	  return value == POLYFILL ? true : value == NATIVE ? false : typeof detection == 'function' ? fails$Y(detection) : !!detection;
	};
	...
	*/
	...
	objectGetOwnPropertyNamesExternal.f = function getOwnPropertyNames(it) {
	  return windowNames && toString$r.call(it) == '[object Window]' ? getWindowNames(it) : $getOwnPropertyNames$1(toIndexedObject$9(it));
	};
	...
	var setToStringTag$b = function (it, TAG, STATIC) {
	  if (it && !has$g(it = STATIC ? it : it.prototype, TO_STRING_TAG$8)) {
	    defineProperty$e(it, TO_STRING_TAG$8, {
	      configurable: true,
	      value: TAG
	    });
	  }
	...
	var arraySpeciesConstructor$2 = function (originalArray) {
	  ...
	  if (isArray$7(originalArray)) {
	    ...
	    if (typeof C == 'function' && (C === Array || isArray$7(C.prototype))) C = undefined;else if (isObject$w(C)) {
	      C = C[SPECIES$6];
	...
	var QObject = global$A.QObject; // Don't use setters in Qt Script, https://github.com/zloirock/core-js/issues/173
	...
	if (DESCRIPTORS$t && typeof NativeSymbol == 'function' && (!('description' in NativeSymbol.prototype) || // Safari 12 bug
	...
	var getIteratorMethod$8 = function (it) {
	  if (it != undefined) return it[ITERATOR$7] || it['@@iterator'] || Iterators$3[classof$a(it)];
	};
	...
	var addToUnscopables$g = addToUnscopables$h; // `Array.prototype.copyWithin` method
	// https://tc39.es/ecma262/#sec-array.prototype.copywithin
	...
	var toLength$w = toLength$C; // `Array.prototype.fill` method implementation
	...
	var addToUnscopables$f = addToUnscopables$h; // `Array.prototype.fill` method
	// https://tc39.es/ecma262/#sec-array.prototype.fill
	...
	var bind$n = functionBindContext; // `FlattenIntoArray` abstract operation
	...
	/* , mapfn = undefined, thisArg = undefined */
	  ...
	  if (mapping) mapfn = bind$m(mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2); // if the target is not iterable or it's an array with the default iterator - use a simple case
	...
	var addToUnscopables$c = addToUnscopables$h; // `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	...
	if (!has$c(IteratorPrototype$3, ITERATOR$5)) {
	...
	var createIteratorConstructor$7 = function (IteratorConstructor, NAME, next) {
	  ...
	  IteratorConstructor.prototype = create$b(IteratorPrototype$2, {
	...
	var toLength$q = toLength$C; // `Array.prototype.{ reduce, reduceRight }` methods implementation
	...
	var addToUnscopables$a = addToUnscopables$h; // https://tc39.es/ecma262/#sec-array.prototype-@@unscopables
	...
	var toLength$m = toLength$C; // `ToIndex` abstract operation
	...
	var isView = function isView(it) {
	  ...
	  return klass === 'DataView' || has$b(TypedArrayConstructorsList, klass) || has$b(BigIntArrayConstructorsList, klass);
	};

	var isTypedArray$1 = function (it) {
	  if (!isObject$q(it)) return false;
	  var klass = classof$8(it);
	  return has$b(TypedArrayConstructorsList, klass) || has$b(BigIntArrayConstructorsList, klass);
	};
	...
	var exportTypedArrayMethod$u = function (KEY, property, forced) {
	  ...
	  if (forced) for (var ARRAY in TypedArrayConstructorsList) {
	    ...
	    if (TypedArrayConstructor && has$b(TypedArrayConstructor.prototype, KEY)) try {
	  ...
	  if (!TypedArrayPrototype$1[KEY] || forced) {
	    redefine$b(TypedArrayPrototype$1, KEY, forced ? property : NATIVE_ARRAY_BUFFER_VIEWS$3 && Int8ArrayPrototype[KEY] || property);
	  }
	};
	...
	var exportTypedArrayStaticMethod$2 = function (KEY, property, forced) {
	  ...
	  if (setPrototypeOf$4) {
	    if (forced) for (ARRAY in TypedArrayConstructorsList) {
	      ...
	      if (TypedArrayConstructor && has$b(TypedArrayConstructor, KEY)) try {
	...
	for (NAME$1 in TypedArrayConstructorsList) {
	  ...
	  if (Prototype) createNonEnumerableProperty$d(Prototype, TYPED_ARRAY_CONSTRUCTOR$2, Constructor);else NATIVE_ARRAY_BUFFER_VIEWS$3 = false;
	}
	...
	if (DESCRIPTORS$q && !has$b(TypedArrayPrototype$1, TO_STRING_TAG$5)) {
	  TYPED_ARRAY_TAG_REQIRED = true;
	  defineProperty$b(TypedArrayPrototype$1, TO_STRING_TAG$5, {
	    get: function () {
	  ...
	  for (NAME$1 in TypedArrayConstructorsList) if (global$v[NAME$1]) {
	    createNonEnumerableProperty$d(global$v[NAME$1], TYPED_ARRAY_TAG$1, NAME$1);
	  }
	}
	...
	var NATIVE_ARRAY_BUFFER_VIEWS$2 = ArrayBufferViewCore$w.NATIVE_ARRAY_BUFFER_VIEWS; // `ArrayBuffer.isView` method
	...
	var SPECIES$2 = wellKnownSymbol$l('species'); // `SpeciesConstructor` abstract operation
	...
	var $$3K = _export; // `Date.now` method
	...
	var $$3I = _export; // `Date.prototype.toGMTString` method
	...
	var requireObjectCoercible$f = requireObjectCoercible$i; // `String.prototype.repeat` method implementation
	...
	var bind$l = functionBind; // `Function.prototype.bind` method
	// https://tc39.es/ecma262/#sec-function.prototype.bind
	...
	var global$u = global$M; // `globalThis` object
	...
	var onFreeze$3 = function (it) {
	  if (FREEZING$4 && REQUIRED && isExtensible$1(it) && !has$a(it, METADATA)) setMetadata(it);
	  return it;
	};
	...
	var inheritIfRequired$4 = function ($this, dummy, Wrapper) {
	  ...
	  typeof (NewTarget = dummy.constructor) == 'function' && NewTarget !== Wrapper && isObject$m(NewTargetPrototype = NewTarget.prototype) && NewTargetPrototype !== Wrapper.prototype) setPrototypeOf$3($this, NewTargetPrototype);
	  return $this;
	};
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$3(CONSTRUCTOR_NAME, typeof NativeConstructor != 'function' || !(IS_WEAK || NativePrototype.forEach && !fails$I(function () {
	  ...
	  if (REPLACE) {
	    ...
	    var THROWS_ON_PRIMITIVES = fails$I(function () {
	      instance.has(1);
	...
	var $$3y = _export; // eslint-disable-next-line es/no-math-asinh -- required for testing
	...
	var $$3x = _export; // eslint-disable-next-line es/no-math-atanh -- required for testing
	...
	var $$3r = _export; // eslint-disable-next-line es/no-math-hypot -- required for testing
	...
	var fails$H = fails$11; // eslint-disable-next-line es/no-math-imul -- required for testing
	...
	var BROKEN_CLASSOF = classof$7(create$9(NumberPrototype)) == NUMBER; // `ToNumber` abstract operation
	...
	if (isForced$2(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
	  ...
	  'fromString,range').split(','), j = 0, key; keys$1.length > j; j++) {
	    if (has$9(NativeNumber, key = keys$1[j]) && !has$9(NumberWrapper, key)) {
	...
	var $$3i = _export; // `Number.EPSILON` constant
	...
	var globalIsFinite = global$q.isFinite; // `Number.isFinite` method
	...
	var floor$5 = Math.floor; // `Number.isInteger` method implementation
	...
	var isInteger$2 = isInteger$3; // `Number.isInteger` method
	// https://tc39.es/ecma262/#sec-number.isinteger
	...
	var $$3f = _export; // `Number.isNaN` method
	...
	var $$3d = _export; // `Number.MAX_SAFE_INTEGER` constant
	...
	var $$3c = _export; // `Number.MIN_SAFE_INTEGER` constant
	...
	var FORCED$j = 1 / $parseFloat(whitespaces$2 + '-0') !== -Infinity; // `parseFloat` method
	...
	var hex = /^[+-]?0[Xx]/;
	var FORCED$i = $parseInt(whitespaces$1 + '08') !== 8 || $parseInt(whitespaces$1 + '0x16') !== 22; // `parseInt` method
	...
	var classof$6 = classofRaw$1; // `thisNumberValue` abstract operation
	...
	var FORCED$h = nativeToFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !fails$E(function () {
	  // V8 ~ Android 4.3-
	  nativeToFixed.call({});
	...
	var create$8 = objectCreate$1; // `Object.create` method
	// https://tc39.es/ecma262/#sec-object.create
	...
	if (DESCRIPTORS$k) {
	  $$35({
	    ...
	    __defineGetter__: function __defineGetter__(P, getter) {
	      definePropertyModule$4.f(toObject$h(this), P, {
	        get: aFunction$L(getter),
	        enumerable: true,
	        configurable: true
	      });
	    }
	...
	if (DESCRIPTORS$h) {
	  $$32({
	    ...
	    __defineSetter__: function __defineSetter__(P, setter) {
	      definePropertyModule$3.f(toObject$g(this), P, {
	        set: aFunction$K(setter),
	        enumerable: true,
	        configurable: true
	      });
	    }
	...
	var FAILS_ON_PRIMITIVES$9 = fails$A(function () {
	  $freeze(1);
	...
	var FAILS_ON_PRIMITIVES$8 = fails$z(function () {
	  nativeGetOwnPropertyDescriptor$1(1);
	});
	var FORCED$d = !DESCRIPTORS$f || FAILS_ON_PRIMITIVES$8; // `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	...
	var FAILS_ON_PRIMITIVES$7 = fails$y(function () {
	...
	var FAILS_ON_PRIMITIVES$6 = fails$x(function () {
	...
	var FAILS_ON_PRIMITIVES$4 = fails$v(function () {
	  $isFrozen(1);
	...
	var FAILS_ON_PRIMITIVES$3 = fails$u(function () {
	  $isSealed(1);
	...
	var FAILS_ON_PRIMITIVES$2 = fails$t(function () {
	  nativeKeys(1);
	}); // `Object.keys` method
	// https://tc39.es/ecma262/#sec-object.keys
	...
	var fails$s = fails$11; // eslint-disable-next-line es/no-object-preventextensions -- safe


	var $preventExtensions = Object.preventExtensions;
	var FAILS_ON_PRIMITIVES$1 = fails$s(function () {
	  $preventExtensions(1);
	...
	var fails$r = fails$11; // eslint-disable-next-line es/no-object-seal -- safe


	var $seal = Object.seal;
	var FAILS_ON_PRIMITIVES = fails$r(function () {
	  $seal(1);
	}); // `Object.seal` method
	...
	var toString$i = objectToString; // `Object.prototype.toString` method
	// https://tc39.es/ecma262/#sec-object.prototype.tostring


	if (!TO_STRING_TAG_SUPPORT) {
	  redefine$7(Object.prototype, 'toString', toString$i, {
	    unsafe: true
	  });
	}
	...
	var post = function (id) {
	  ...
	  global$l.postMessage(String(id), location.protocol + '//' + location.host);
	...
	if (!set$1 || !clear) {
	  ...
	  } else if (global$l.addEventListener && typeof postMessage == 'function' && !global$l.importScripts && location && location.protocol !== 'file:' && !fails$q(post)) {
	    defer = post;
	    global$l.addEventListener('message', listener, false); // IE8-
	...
	var Promise$4 = global$k.Promise; // Node.js 11 shows ExperimentalWarning on getting `queueMicrotask`
	...
	var dispatchEvent = function (name, promise, reason) {
	  ...
	  if (!NATIVE_REJECTION_EVENT && (handler = global$i['on' + name])) handler(event);else if (name === UNHANDLED_REJECTION) hostReportErrors$1('Unhandled promise rejection', reason);
	};
	...
	var redefine$5 = redefine$g.exports; // Safari bug https://bugs.webkit.org/show_bug.cgi?id=200829
	...
	if (typeof NativePromise == 'function') {
	  ...
	  if (NativePromise.prototype['finally'] !== method) {
	    redefine$5(NativePromise.prototype, 'finally', method, {
	      unsafe: true
	    });
	  }
	}
	...
	$$2E({
	  ...
	  /* , newTarget */
	    ...
	    var instance = create$7(isObject$b(proto) ? proto : Object.prototype);
	...
	var fails$m = fails$11; // MS Edge has broken Reflect.defineProperty - throwing instead of returning false
	...
	var getPrototypeOf$5 = objectGetPrototypeOf$1; // `Reflect.get` method
	...
	/* , receiver */
	  ...
	  if (descriptor = getOwnPropertyDescriptorModule$3.f(target, propertyKey)) return has$8(descriptor, 'value') ? descriptor.value : descriptor.get === undefined ? undefined : descriptor.get.call(receiver);
	...
	var MATCH$2 = wellKnownSymbol$h('match'); // `IsRegExp` abstract operation
	...
	var fails$k = fails$11; // babel-minify transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError,
	...
	var BASE_FORCED = DESCRIPTORS$9 && (!CORRECT_NEW || UNSUPPORTED_Y$3 || UNSUPPORTED_DOT_ALL$2 || UNSUPPORTED_NCG$1 || fails$h(function () {
	...
	var NOT_GENERIC = fails$f(function () {
	...
	var requireObjectCoercible$c = requireObjectCoercible$i; // `String.prototype.codePointAt` methods implementation
	...
	var getInternalState$9 = InternalStateModule$c.getterFor(STRING_ITERATOR$1); // `String.prototype[@@iterator]` method
	...
	var SPECIES = wellKnownSymbol$e('species');
	...
	var MATCH_ALL = wellKnownSymbol$d('matchAll');
	...
	var userAgent$1 = engineUserAgent; // eslint-disable-next-line unicorn/no-unsafe-regex -- safe
	...
	var toString$9 = toString$s; // `String.raw` method
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  function replace(searchValue, replaceValue) {
	    ...
	    return replacer !== undefined ? replacer.call(searchValue, O, replaceValue) : nativeReplace.call(toString$8(O), searchValue, replaceValue);
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  function (string, limit) {
	    ...
	    while (q < S.length) {
	      ...
	      if (z === null || (e = min$3(toLength$d(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)), S.length)) === p) {
	...
	var slice$1 = ''.slice;
	var max$1 = Math.max;
	var min$1 = Math.min; // `String.prototype.substr` method
	...
	var fails$9 = fails$11; // check the existence of a method, lowercase
	...
	var exportTypedArrayMethod$t = ArrayBufferViewCore$u.exportTypedArrayMethod; // `%TypedArray%.prototype.copyWithin` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.copywithin

	exportTypedArrayMethod$t('copyWithin', function copyWithin(target, start
	/* , end */
	) {
	...
	var exportTypedArrayMethod$s = ArrayBufferViewCore$t.exportTypedArrayMethod; // `%TypedArray%.prototype.every` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.every

	exportTypedArrayMethod$s('every', function every(callbackfn
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$r = ArrayBufferViewCore$s.exportTypedArrayMethod; // `%TypedArray%.prototype.fill` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.fill
	// eslint-disable-next-line no-unused-vars -- required for `.length`

	exportTypedArrayMethod$r('fill', function fill(value
	/* , start, end */
	) {
	...
	var aTypedArrayConstructor$1 = ArrayBufferViewCore$r.aTypedArrayConstructor; // a part of `TypedArraySpeciesCreate` abstract operation
	...
	var exportTypedArrayMethod$q = ArrayBufferViewCore$q.exportTypedArrayMethod; // `%TypedArray%.prototype.filter` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.filter

	exportTypedArrayMethod$q('filter', function filter(callbackfn
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$p = ArrayBufferViewCore$p.exportTypedArrayMethod; // `%TypedArray%.prototype.find` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.find

	exportTypedArrayMethod$p('find', function find(predicate
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$o = ArrayBufferViewCore$o.exportTypedArrayMethod; // `%TypedArray%.prototype.findIndex` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.findindex

	exportTypedArrayMethod$o('findIndex', function findIndex(predicate
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$n = ArrayBufferViewCore$n.exportTypedArrayMethod; // `%TypedArray%.prototype.forEach` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.foreach

	exportTypedArrayMethod$n('forEach', function forEach(callbackfn
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$m = ArrayBufferViewCore$m.exportTypedArrayMethod; // `%TypedArray%.prototype.includes` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.includes

	exportTypedArrayMethod$m('includes', function includes(searchElement
	/* , fromIndex */
	) {
	...
	var exportTypedArrayMethod$l = ArrayBufferViewCore$l.exportTypedArrayMethod; // `%TypedArray%.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.indexof

	exportTypedArrayMethod$l('indexOf', function indexOf(searchElement
	/* , fromIndex */
	) {
	...
	exportTypedArrayMethod$k('values', typedArrayValues, !CORRECT_ITER_NAME); // `%TypedArray%.prototype[@@iterator]` method
	...
	var exportTypedArrayMethod$i = ArrayBufferViewCore$i.exportTypedArrayMethod; // `%TypedArray%.prototype.lastIndexOf` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.lastindexof
	// eslint-disable-next-line no-unused-vars -- required for `.length`

	exportTypedArrayMethod$i('lastIndexOf', function lastIndexOf(searchElement
	/* , fromIndex */
	) {
	...
	var exportTypedArrayMethod$h = ArrayBufferViewCore$h.exportTypedArrayMethod; // `%TypedArray%.prototype.map` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.map

	exportTypedArrayMethod$h('map', function map(mapfn
	/* , thisArg */
	) {
	...
	var exportTypedArrayStaticMethod = ArrayBufferViewCore$g.exportTypedArrayStaticMethod; // `%TypedArray%.of` method
	...
	var exportTypedArrayMethod$g = ArrayBufferViewCore$f.exportTypedArrayMethod; // `%TypedArray%.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.reduce

	exportTypedArrayMethod$g('reduce', function reduce(callbackfn
	/* , initialValue */
	) {
	...
	var exportTypedArrayMethod$f = ArrayBufferViewCore$e.exportTypedArrayMethod; // `%TypedArray%.prototype.reduceRicht` method
	...
	exportTypedArrayMethod$d('set', function set(arrayLike
	/* , offset */
	) {
	  aTypedArray$c(this);
	...
	var exportTypedArrayMethod$b = ArrayBufferViewCore$a.exportTypedArrayMethod; // `%TypedArray%.prototype.some` method
	// https://tc39.es/ecma262/#sec-%typedarray%.prototype.some

	exportTypedArrayMethod$b('some', function some(callbackfn
	/* , thisArg */
	) {
	...
	var exportTypedArrayMethod$9 = ArrayBufferViewCore$8.exportTypedArrayMethod; // `%TypedArray%.prototype.subarray` method
	...
	exportTypedArrayMethod$9('subarray', function subarray(begin, end) {
	  ...
	  return new C(O.buffer, O.byteOffset + beginIndex * O.BYTES_PER_ELEMENT, toLength$7((end === undefined ? length : toAbsoluteIndex(end, length)) - beginIndex));
	});
	...
	var IS_IE11 = !global$9.ActiveXObject && 'ActiveXObject' in global$9; // eslint-disable-next-line es/no-object-isextensible -- safe
	...
	var addToUnscopables$8 = addToUnscopables$h; // `Array.prototype.at` method
	...
	var toLength$5 = toLength$C; // `Array.prototype.{ findLast, findLastIndex }` methods implementation
	...
	var FORCED$2 = typeof NativeIterator != 'function' || NativeIterator.prototype !== IteratorPrototype // FF44- non-standard `Iterator` passes previous tests
	|| !fails$2(function () {
	  NativeIterator({});
	});
	...
	var $$$ = _export; // `Math.DEG_PER_RAD` constant
	// https://rwaldron.github.io/proposal-math-extensions/
	...
	var $$Y = _export; // `Math.iaddh` method
	...
	var $$X = _export; // `Math.imulh` method
	// https://gist.github.com/BrendanEich/4294d5c212a6d2254703
	// TODO: Remove from `core-js@4`
	...
	var $$W = _export; // `Math.isubh` method
	// https://gist.github.com/BrendanEich/4294d5c212a6d2254703
	// TODO: Remove from `core-js@4`
	...
	var $$V = _export; // `Math.RAD_PER_DEG` constant
	// https://rwaldron.github.io/proposal-math-extensions/
	...
	var $$Q = _export; // `Math.umulh` method
	// https://gist.github.com/BrendanEich/4294d5c212a6d2254703
	// TODO: Remove from `core-js@4`
	...
	var hasOwn$1 = has$o; // `Object.hasOwn` method
